...
#define CUSTOM_MACHINE_NAME "Foil-Welding"
...
#define TEMP_RESIDENCY_TIME     50  // (seconds) Time to wait for hotend to "settle" in M109
...
#define TEMP_BED_HYSTERESIS      100  // (°C) Temperature proximity considered "close enough" to the target
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 7.1
    #define DEFAULT_Ki 0.09
    #define DEFAULT_Kd 133.99
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 400 // If the temperature difference between the target temperature and the actual temperature
...
//#define NO_MOTION_BEFORE_HOMING // Inhibit movement until all axes have been d
